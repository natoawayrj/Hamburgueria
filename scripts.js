...
function addToCard(name,price){
  ...
  if(existingItem){
    // se o item já existir, aumente só a quantidade
   ...
   cart.forEach(item=>{
    ...
    cartItemElement.innerHTML = `
      <div class="flex items-center justify-between">
         ...
         <div class="bg-black text-white px-4 py-2 rounded">
...
//função para remover item
   ...
   checkOutBtn.addEventListener("click", function(){
    ...
    if(!isOpen){
     ...
     const phone = '21974837243'

     window.open(`http://wa.me/${phone}?text=${message} Endereço: ${adressInput.value}`)
